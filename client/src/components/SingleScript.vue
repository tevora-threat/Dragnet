    ...
    <v-layout row>
      <v-flex xs12 sm6 offset-sm3>
        <v-card>
                 <v-container>
<h3>Tags</h3>
    <v-chip v-if="scriptTags.urgent" color="blue" text-color="white">Urgent</v-chip>
     <v-chip v-if="scriptTags.breach" color="red" text-color="white">Breach</v-chip>
      <v-chip v-if="scriptTags.sales" color="orange" text-color="white">Sales</v-chip>
       <v-chip v-if="scriptTags.help" color="brown" text-color="white">Help</v-chip>
      <br><br><h3>Script</h3><pre>{{script.script}}</pre>
                 </v-container>
